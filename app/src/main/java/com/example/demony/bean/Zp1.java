...
public class Zp1 {
    ...
    public Zp1(String bh, String zt, String name, String xl, String hy, String szd, String gsdz, String tel, String email, String gw, String xz, String zyyq, String gzjlyq, String gwtq, String shr, String shsj, String time) {
        this.bh = bh;
        this.zt = zt;
        this.name = name;
        this.xl = xl;
