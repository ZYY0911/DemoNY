...
public class Yllbadapter1 extends BaseAdapter {
    ...
    public Yllbadapter1(Context context, List<Yllb> myllb) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.name.setText(yllb.getChangshang());
        viewHolder.xh.setVisibility(View.GONE);
